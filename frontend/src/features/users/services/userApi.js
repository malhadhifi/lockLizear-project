...
export const userApi = {
  ...
  createCustomer: async (customerData) => {
    ...
    const response = await api.post(
      "/customer-management/customer-licenses",
      customerData,
    );
    return response;
  },
  ...
  bulkAction: async (data) => {
    ...
    const response = await api.post(
      "/customer-management/customer-licenses/bulk-action",
      data,
    );
    return response;
  },
  ...
  getCustomerDetails: async (id) => {
    ...
    const response = await api.get(
      `/customer-management/customer-licenses/${id}`,
    );
    return response;
  },
  ...
  downloadLicense: async (id) => {
    const response = await api.get(
      `/customer-management/customer-licenses/${id}/download`,
      {
        responseType: "blob",
      },
    );
  ...
  getCustomerPublications: async (customerId, params) => {
    const response = await api.get(
      `/customer-management/customer-licenses/${customerId}/publications`,
      params
    );
    return response;
  },
  ...
  updatePublicationAccess: async ({ customerId, data }) => {
    const response = await api.post(
      `/customer-management/customer-licenses/${customerId}/publications/bulk-access`,
      data,
    );
    return response;
  },
  ...
  getCustomerDocuments: async (customerId, params) => {
    const response = await api.get(
      `/customer-management/customer-licenses/${customerId}/documents`,
      params,
    );
    return response;
  },
  ...
  updateDocumentAccess: async ({ customerId, data }) => {
    const response = await api.post(
      `/customer-management/customer-licenses/${customerId}/documents/bulk-access`,
      data,
    );
    return response;
  },
