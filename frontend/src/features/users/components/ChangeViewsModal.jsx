/**
 * ChangeViewsModal.jsx - نافذة تعديل عدد المشاهدات مع فلاتر شغالة
 */
...
export default function ChangeViewsModal({ isOpen, onClose, userName = '' }) {
  // تعريف حالة الفلتر نصياً
  const [filterText, setFilterText] = useState('')

  // جلب المستندات بحد أقصى للسرعة (50) وتفعيل ميزة البحث عبر الباك إند مباشرة
    ...
    <div style={overlayStyle}>
      <div style={modalStyle}>
        <div style={headerStyle}>
          <span>Change number of document views for &quot;{userName}&quot;</span>
                      ...
                      <div style={{ backgroundColor: '#fdfdfd', border: '1px solid #eee', borderTop: 'none', padding: '8px 12px' }}>
                        <table style={{ width: '100%', fontSize: 13, color: '#333' }}>
                          <tbody>
                            ...
                            <tr><td style={{ fontWeight: 'bold', padding: '2px 0' }}>Views Left:</td><td style={{ fontWeight: 'bold' }}>0</td></tr>
                          </tbody>
                        </table>
                      </div>
                    </td>
