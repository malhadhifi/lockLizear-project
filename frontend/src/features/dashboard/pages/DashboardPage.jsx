...
const stats = [
  ...
  { label: "suspend", value: "23", icon: "bi-person-x-fill" },
];
...
const recentDocs = [
  ...
  { title: "دليل قواعد البيانات", status: "suspend", date: "2026-03-06" },
];
        ...
        >
          {stats.map((s) => (
            ...
            >
              ...
              />
              <div style={{ fontSize: 22, fontWeight: 800, color: "#333" }}>
                {s.value}
              </div>
            ...
            >
              ...
              <tbody>
                {recentDocs.map((d, i) => (
                  ...
                  >
                    <td style={{ ...tdStyle, fontWeight: 600, color: TEAL }}>
                      {d.title}
                    </td>
                    <td style={tdStyle}>
                      <span
