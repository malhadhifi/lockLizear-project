...
const MOCK_USERS = [
  ...
  { id: 3, name: "محمد علي", email: "mo@email.com", status: "suspend" },
            ...
            {filteredUsers.map((u) => (
              <div
                ...
                style={{
                  ...
                  fontSize: 12,
                  background:
                    selectedUserId === u.id ? "#e0f7fa" : "transparent",
          ...
          {!selectedUser ? (
            <div style={{ textAlign: "center", padding: 60, color: "#888" }}>
              <i
                ...
                style={{ fontSize: 50, display: "block", marginBottom: 12 }}
              />
            ...
            <>
              ...
              >
                {[
                  ...
                  { key: "publications", label: "Publication Access" },
                ].map((tab) => (
                  <button
                    key={tab.key}
                    ...
                    style={{
                      ...
                      color: activeTab === tab.key ? TEAL : "#666",
                      cursor: "pointer",
                    }}
                  >
                    {tab.label}
                          ...
                          <td style={tdStyle}>
                            <button
                              onClick={() => {
                                ...
                                toast.success(
                                  d.granted ? "Revoked" : "Granted",
                                );
                              }}
                              style={{
                                background: d.granted ? "#f44336" : "#4caf50",
                                color: "#fff",
                                border: "none",
                                borderRadius: 3,
                                padding: "3px 10px",
                          ...
                          <td style={tdStyle}>
                            <button
                              onClick={() => {
                                ...
                                toast.success(
                                  p.granted ? "Revoked" : "Granted",
                                );
                              }}
                              style={{
                                background: p.granted ? "#f44336" : "#4caf50",
                                color: "#fff",
                                border: "none",
                                borderRadius: 3,
                                padding: "3px 10px",
